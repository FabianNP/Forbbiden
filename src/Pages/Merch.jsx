...
const Merch = () => {
  ...
  return (
    <section id="products"> <div className={`text-white flex flex-col items-center justify-center w-screen h-[250px] bg-gradient-to-r from-[#5e5e5e5b] to-[#20202098] rounded-xl my-0 py-10 shadow-md shadow-white `}>
